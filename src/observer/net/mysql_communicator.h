...
private:
  ...
  RC write_tuple_result(SqlResult *sql_result, std::vector<char> &packet, int &affected_rows, bool &need_disconnect);
  RC write_chunk_result(SqlResult *sql_result, std::vector<char> &packet, int &affected_rows, bool &need_disconnect);
